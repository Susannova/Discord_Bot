...
class PlayRequestsCog(commands.Cog, name='Play-Request Commands'):
    ...
    @commands.group()
    async def play(self, ctx: commands.Context, games: commands.Greedy[converters.StrToGame], play_time: Optional[converters.StrToTime], player_needed_num: Optional[int], should_be_empty: Optional[str]):
        """ 
